...
<div class="projectteam-form">
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? 'Assign' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-primary' : 'btn btn-primary']) ?>
        <?= Html::a('Cancel', $model->isNewRecord ? Yii::$app->params['default']."index.php/project/view?id=$id":Yii::$app->params['default']."index.php/project/view?id=$model->proyekId", ['class' => 'btn btn-default']) ?>
    </div>
